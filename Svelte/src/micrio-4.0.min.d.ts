declare module 'Micrio' {
     ...
     * @copyright Q42 Internet BV, Micrio, 2015 - 2022
     ...
     *
     * ## Upgrading from Micrio 3.x to 4.0
     *
     * Where previous Micrio versions you would open a marker like this:
     *
     * ```js
     * // Markers are propagated to JS instances on image load
     * const marker = micrioInstance.modules.markers.items[0];
     *
     ...
     * ```
     *
     * in 4.0, this is done with:
     *
     * ```js
     * // The current active shown MicrioImage
     * const image = micrioHTMLElement.$current;
     *
     * // Open the marker simply by setting its original JSON data as `state.marker`
     * image.state.marker.set(image.$data.markers[0]);
     *
     * // Close it after 5 seconds
     * setTimeout(() => { image.state.marker.set(null) }, 5000);
     * ```
     *
     * @author Marcel Duin <marcel@micr.io>
     * @copyright Q42 Internet BV, Micrio, 2015 - 2022
    ...
    */
    export namespace State {
        ...
        */
        class Main {
            private micrio;
            /** The current [[`MarkerTour`]] or [[`VideoTour`]] store */
        ...
        */
        class Image {
             ...
             */
            readonly marker: Writable<Models.ImageCultureData.Marker | string>;
    ...
    */
    export class HTMLMicrioElement extends HTMLElement {
        ...
        */
         ...
         * @readonly
        */
        readonly secondary: Writable<MicrioImage>;
        ...
        */
        open(idOrInfo: string | Partial<Models.ImageInfo.ImageInfo>, asSplitscreen?: boolean): MicrioImage;
    ...
    */
    export class MicrioImage {
        ...
        */
        ...
        readonly data: Writable<Models.ImageCultureData.ImageCultureData>;
    ...
    */
    ...
    export class VideoTour {
        ...
        /** Set the data */
        constructor(micrio: HTMLMicrioElement, data: Models.ImageCultureData.VideoTour);
        destroy(): void;
     ...
     *
     * This will place the image element and will auto-load all required data and any markers and tours you have created in the [Micrio Dashboard](https://dashboard.micr.io/).
     *
     ...
     *
     * <script src="https://b.micr.io/micrio-4.0.min.js"></script>
     * <micr-io id="dzzLm" style="height:500px" ui="false"></micr-io>
     *
     ...
     *
     * If you use TypeScript in your project, you can use the **Micrio Declarations file** [micrio-4.0.min.d.ts](https://b.micr.io/micrio-4.0.min.d.ts)!
     *
